...
(SELECT MAX(voucher_number)+1 FROM account_master WHERE voucher_type_id = voucher_id) ,
(SELECT DISTINCT  series_start FROM voucher WHERE voucher_id = voucher_id)) INTO next_voucher_number ;
