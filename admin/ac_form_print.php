...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->class_list = array("class_voucher.php","class_ledger.php","class_account.php","class_stock.php","class_stock_register.php","class_form_type.php","class_form_variable.php");
