...
$page = new Page;
	...
	$page->page_name = 'ac_tax';		// page name for menu and other purpose
	...
	$page->class_list = array("class_tax.php","class_pagination.php","class_ledger.php","class_account_settings.php","class_fy_ledger_sub.php");
