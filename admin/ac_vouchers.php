...
$page = new Page;
	...
	$page->page_name = 'ac_vouchers';		// page name for menu and other purpose
	...
	$page->class_list = array("class_voucher.php","class_account_settings.php","class_ledger.php","class_form_type.php","class_module.php");
