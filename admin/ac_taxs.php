...
$page = new Page;
	...
	$page->page_name = 'ac_taxs';		// page name for menu and other purpose
	...
	$page->class_list = array("class_tax.php","class_pagination.php","class_account_settings.php");
