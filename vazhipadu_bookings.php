...
$page = new Page;
	...
	$page->page_name = 'vazhipadu_bookings';		// page name for menu and other purpose
	...
	$page->class_list = array("class_vazhipadu.php","class_pooja.php","class_pagination.php", "class_account_settings.php");
