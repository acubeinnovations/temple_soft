...
$RD_MSG_changed_password  = "Password Updated,Email Notification send to users email id.";

$RD_MSG_changed_password_failed="Problem occured during updation.please try after some time";
$CAP_page_caption = "Change Password";

$CAP_password = "Password";

$CAP_new_password = "New Password";

$CAP_retype_password = "Retype New Password";
?>
