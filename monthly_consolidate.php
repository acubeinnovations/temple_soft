...
$page = new Page;
	...
	$page->page_name = 'monthly_consolidate';		// page name for menu and other purpose
	...
	$page->class_list = array("class_vazhipadu.php","class_user.php","class_account_settings.php");
