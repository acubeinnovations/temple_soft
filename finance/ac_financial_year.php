...
$page = new Page;
	...
	$page->class_list = array("class_financial_year.php","class_pagination.php","class_balancesheet.php", "class_account.php", "class_stock_register.php");
