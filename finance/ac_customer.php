...
$page = new Page;
	...
	$page->title = "Finance - Customer";	// page Title
	...
	$page->class_list = array("class_customer.php","class_pagination.php","class_ledger.php","class_fy_ledger_sub.php","class_account_settings.php");
