...
$page = new Page;
	...
	$page->page_name = 'add_menu';		// page name for menu and other purpose
	...
	$page->class_list = array("class_pages.php","class_user_page.php","class_user_type_page.php","class_menu_item.php");
