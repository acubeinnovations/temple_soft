...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->page_name = 'ac_voucher_print';		// page name for menu and other purpose
	...
	$page->class_list = array("class_voucher.php","class_ledger.php","class_account.php","class_stock.php","class_stock_register.php");
